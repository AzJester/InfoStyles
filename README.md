...
- **Upload skills you've already built**: the skill editor accepts a `SKILL.md` (frontmatter parsed into name/description, body into instructions), a `.zip`/`.skill` package (filled from the `SKILL.md` inside, with the package's file list captured), or a `.json` array for bulk import.
